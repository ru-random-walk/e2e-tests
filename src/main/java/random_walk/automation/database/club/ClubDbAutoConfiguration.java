package random_walk.automation.database.club;
...
@Configuration
@ComponentScan("random_walk.automation.database.club")
@EnableTransactionManagement
@EnableJpaRepositories(basePackages = "random_walk.automation.database.club.repos",
...
public class ClubDbAutoConfiguration {
    ...
    public LocalContainerEntityManagerFactoryBean clubEntityManagerFactory(@Qualifier("clubBuilder") EntityManagerFactoryBuilder builder) {
        return builder.dataSource(clubDataSource())
                .packages("random_walk.automation.database.club.entities")
