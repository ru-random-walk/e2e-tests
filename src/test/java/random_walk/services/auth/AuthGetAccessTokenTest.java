package random_walk.services.auth;
...
import random_walk.automation.utils.ParseAccessTokenUtils;
...
class AuthGetAccessTokenTest extends BaseTest {
    ...
    void getAccessTokenForUser() {
        ...
        step("THEN: Access_token успешно получен", () -> {
            var tokenInfo = new ParseAccessTokenUtils().getInfoFromAccessToken(accessToken);
            assertAll(
